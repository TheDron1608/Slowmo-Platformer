...
public class TutorialCursePickManager : AbstractModificatorCardsManager
{
    ...
    public static TutorialCursePickManager Instance;
    ...
    private IEnumerator TradeCoroutine()
    {
        if (ModificatorsManager.Instance != null && ScoreManager.Instance != null)
        {
            ...
            float totalTradableScore = math.max(ScoreManager.Instance.TradableScore + ScoreManager.Instance.CurrentCombo * ScoreManager.Instance.CurrentMultiplier, MinScore);
